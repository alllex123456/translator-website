    ...
    <div className="bg-dark-10">
      <Section>
        <div className="grid gap-[10rem] grid-cols-2 px-10 lg:gap-10 md:grid-cols-1">
          <div className="text-light-80 w-[80%] lg:w-[100%]">
            <h4 className="text-light-83 mb-10">
              ...
              prețurile variază în funcție de complexitatea, volumul și termenul
              de livrare. Pentru a obține o ofertă de preț, îmi poți trimite
          ...
          <div className="border border-dark-25 p-20 flex flex-col h-[30rem] justify-self-center self-center radius text-light-83 text-xl">
